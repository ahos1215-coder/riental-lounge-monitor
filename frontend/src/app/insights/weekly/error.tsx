...
export default function WeeklyInsightsError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[megribi] weekly-insights error:", error);
  }, [error]);
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-10 text-white">
      ...
      <div className="mt-10 rounded-2xl border border-rose-500/20 bg-rose-950/20 p-8 text-center">
        <h1 className="text-lg font-semibold text-white">インサイトを読み込めませんでした</h1>
