    ...
    <main className="mx-auto w-full max-w-3xl px-4 py-10">
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-white/80">
        ...
        <section>
          ...
          <p className="mt-3">
            当サービスが提供する混雑予測は、過去のデータに基づく機械学習モデル（LightGBM）
        ...
        <section>
          ...
          <p className="mt-3">
            一部のブランド（相席屋）では、公式サイトの表示が在店人数ではなく
            「席の埋まり具合（%）」のみです。当サービスでもこのブランドについては、
            公式サイトの表示（席の埋まり具合%）をもとに独自に推計した参考値であり、
            正確な在店人数ではない、割合（%）のみを利用者向けに表示しています。
          </p>
          <p className="mt-2">
            なお、データの保存処理上、内部的にはこの割合（%）から人数を逆算した推計値を
            算出・保存する場合がありますが、この内部推計人数を利用者向けに表示することは
            ありません。
          </p>
        </section>
      ...
      <p className="mt-10 text-xs text-white/40">最終更新: 2026年8月19日</p>
    </main>
  );
}
