...
import { detectAisekiyaDayTypeJst } from "@/lib/pricing/jpHolidays";
import {
  recommendEntryTime,
...
import {
  buildEntryTimeOptions,
  buildExitTimeOptions,
  DayTypeToggle,
  yen,
} from "./OrientalCostSimulatorCard";
...
export function AisekiyaCostSimulatorCard({
  pricing,
  series,
  hasForecast,
}: {
  ...
  const markCostSimInteract = useCallback(() => {
    ...
    track("cost_sim_interact", { brand: "aisekiya", store_slug: pricing.storeSlug });
  }, [pricing.storeSlug]);
