...
export function buildEntryTimeOptions(pricing: PricingTable, dayType: DayType): { value: string; label: string }[] {
...
export function buildExitTimeOptions(
...
export function OrientalCostSimulatorCard({
  pricing,
  series,
  hasForecast,
}: {
